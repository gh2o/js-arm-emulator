...
#define ROW_0_1(q9,qb,qd,qf) r01a, r01b, r01a, r01b, \
	...
	/* 0x00 */ ROW_0_1(MUL_MLA,LDR_STR_misc_reg,LDR_STR_misc_reg,LDR_STR_misc_reg),
	/* 0x01 */ ROW_0_1(MUL_MLA,LDR_STR_misc_reg,LDR_STR_misc_reg,LDR_STR_misc_reg),
	/* 0x02 */ ROW_0_1(MUL_MLA,UND,UND,UND),
	/* 0x03 */ ROW_0_1(MUL_MLA,UND,UND,UND),
	/* 0x04 */ ROW_0_1(UND,LDR_STR_misc_imm,LDR_STR_misc_imm,LDR_STR_misc_imm),
	/* 0x05 */ ROW_0_1(UND,LDR_STR_misc_imm,LDR_STR_misc_imm,LDR_STR_misc_imm),
	/* 0x06 */ ROW_0_1(UND,UND,UND,UND),
	/* 0x07 */ ROW_0_1(UND,UND,UND,UND),
	/* 0x08 */ ROW_0_1(SMULL_SMLAL_UMULL_UMLAL,LDR_STR_misc_reg,LDR_STR_misc_reg,LDR_STR_misc_reg),
	/* 0x09 */ ROW_0_1(SMULL_SMLAL_UMULL_UMLAL,LDR_STR_misc_reg,LDR_STR_misc_reg,LDR_STR_misc_reg),
	/* 0x0A */ ROW_0_1(SMULL_SMLAL_UMULL_UMLAL,UND,UND,UND),
	/* 0x0B */ ROW_0_1(SMULL_SMLAL_UMULL_UMLAL,UND,UND,UND),
	/* 0x0C */ ROW_0_1(SMULL_SMLAL_UMULL_UMLAL,LDR_STR_misc_imm,LDR_STR_misc_imm,LDR_STR_misc_imm),
	/* 0x0D */ ROW_0_1(SMULL_SMLAL_UMULL_UMLAL,LDR_STR_misc_imm,LDR_STR_misc_imm,LDR_STR_misc_imm),
	...
	/* 0x10 */
		...
		und, und, und, und,
		und, SUBDECODER_FUNCTION(SWP_SWPB), und, SUBDECODER_FUNCTION(LDR_STR_misc_reg),
		und, SUBDECODER_FUNCTION(LDR_STR_misc_reg), und, SUBDECODER_FUNCTION(LDR_STR_misc_reg),
	/* 0x11 */ ROW_0_1(UND,LDR_STR_misc_reg,LDR_STR_misc_reg,LDR_STR_misc_reg),
	/* 0x12 */
		SUBDECODER_FUNCTION(MSR_reg), SUBDECODER_FUNCTION(BX), und, und,
		und, und, und, und,
		und, und, und, SUBDECODER_FUNCTION(LDR_STR_misc_reg),
		und, SUBDECODER_FUNCTION(LDR_STR_misc_reg), und, SUBDECODER_FUNCTION(LDR_STR_misc_reg),
	/* 0x13 */ ROW_0_1(UND,LDR_STR_misc_reg,LDR_STR_misc_reg,LDR_STR_misc_reg),
	/* 0x14 */
		SUBDECODER_FUNCTION(MRS), und, und, und,
		und, und, und, und,
		und, und, und, SUBDECODER_FUNCTION(LDR_STR_misc_imm),
		und, SUBDECODER_FUNCTION(LDR_STR_misc_imm), und, SUBDECODER_FUNCTION(LDR_STR_misc_imm),
	/* 0x15 */ ROW_0_1(UND,LDR_STR_misc_imm,LDR_STR_misc_imm,LDR_STR_misc_imm),
	/* 0x16 */
		SUBDECODER_FUNCTION(MSR_reg), und, und, und,
		und, und, und, und,
		und, und, und, SUBDECODER_FUNCTION(LDR_STR_misc_imm),
		und, SUBDECODER_FUNCTION(LDR_STR_misc_imm), und, SUBDECODER_FUNCTION(LDR_STR_misc_imm),
	/* 0x17 */ ROW_0_1(UND,LDR_STR_misc_imm,LDR_STR_misc_imm,LDR_STR_misc_imm),
...
#undef ROW_0_1
	...
	/* 0x40 */ FILL16(LDR_STR_LDRB_STRB_imm),
	/* 0x41 */ FILL16(LDR_STR_LDRB_STRB_imm),
	/* 0x42 */ FILL16(LDR_STR_LDRB_STRB_imm),
	/* 0x43 */ FILL16(LDR_STR_LDRB_STRB_imm),
	/* 0x44 */ FILL16(LDR_STR_LDRB_STRB_imm),
	/* 0x45 */ FILL16(LDR_STR_LDRB_STRB_imm),
	/* 0x46 */ FILL16(LDR_STR_LDRB_STRB_imm),
	/* 0x47 */ FILL16(LDR_STR_LDRB_STRB_imm),
	/* 0x48 */ FILL16(LDR_STR_LDRB_STRB_imm),
	/* 0x49 */ FILL16(LDR_STR_LDRB_STRB_imm),
	/* 0x4A */ FILL16(LDR_STR_LDRB_STRB_imm),
	/* 0x4B */ FILL16(LDR_STR_LDRB_STRB_imm),
	/* 0x4C */ FILL16(LDR_STR_LDRB_STRB_imm),
	/* 0x4D */ FILL16(LDR_STR_LDRB_STRB_imm),
	/* 0x4E */ FILL16(LDR_STR_LDRB_STRB_imm),
	/* 0x4F */ FILL16(LDR_STR_LDRB_STRB_imm),
...
#define ROW_6_7_LDR_STR() r67a, r67a, r67a, r67a, r67a, r67a, r67a, r67a
	...
	/* 0x60 */ ROW_6_7_LDR_STR(),
	/* 0x61 */ ROW_6_7_LDR_STR(),
	/* 0x62 */ FILL16(UND),
	/* 0x63 */ FILL16(UND),
	/* 0x64 */ ROW_6_7_LDR_STR(),
	/* 0x65 */ ROW_6_7_LDR_STR(),
	/* 0x66 */ FILL16(UND),
	/* 0x67 */ FILL16(UND),
	/* 0x68 */ ROW_6_7_LDR_STR(),
	/* 0x69 */ ROW_6_7_LDR_STR(),
	/* 0x6A */ FILL16(UND),
	/* 0x6B */ FILL16(UND),
	/* 0x6C */ ROW_6_7_LDR_STR(),
	/* 0x6D */ ROW_6_7_LDR_STR(),
	/* 0x6E */ FILL16(UND),
	/* 0x6F */ FILL16(UND),

	/* 0x70 */ ROW_6_7_LDR_STR(),
	/* 0x71 */ ROW_6_7_LDR_STR(),
	/* 0x72 */ ROW_6_7_LDR_STR(),
	/* 0x73 */ ROW_6_7_LDR_STR(),
	/* 0x74 */ ROW_6_7_LDR_STR(),
	/* 0x75 */ ROW_6_7_LDR_STR(),
	/* 0x76 */ ROW_6_7_LDR_STR(),
	/* 0x77 */ ROW_6_7_LDR_STR(),
	/* 0x78 */ ROW_6_7_LDR_STR(),
	/* 0x79 */ ROW_6_7_LDR_STR(),
	/* 0x7A */ ROW_6_7_LDR_STR(),
...
#undef ROW_6_7_LDR_STR
	...
	/* 0x82 */ FILL16(LDM_STM),
	/* 0x83 */ FILL16(LDM_STM),
	/* 0x84 */ FILL16(LDM_STM_privileged),
	/* 0x85 */ FILL16(LDM_STM_privileged),
	/* 0x86 */ FILL16(UND),
	/* 0x87 */ FILL16(LDM_STM_privileged),
	/* 0x88 */ FILL16(LDM_STM),
	/* 0x89 */ FILL16(LDM_STM),
	/* 0x8A */ FILL16(LDM_STM),
	/* 0x8B */ FILL16(LDM_STM),
	/* 0x8C */ FILL16(LDM_STM_privileged),
	/* 0x8D */ FILL16(LDM_STM_privileged),
	/* 0x8E */ FILL16(UND),
	/* 0x8F */ FILL16(LDM_STM_privileged),
	...
	/* 0x96 */ FILL16(UND),
	/* 0x97 */ FILL16(LDM_STM_privileged),
	/* 0x98 */ FILL16(LDM_STM),
	/* 0x99 */ FILL16(LDM_STM),
	/* 0x9A */ FILL16(LDM_STM),
	/* 0x9B */ FILL16(LDM_STM),
	/* 0x9C */ FILL16(LDM_STM_privileged),
	/* 0x9D */ FILL16(LDM_STM_privileged),
	/* 0x9E */ FILL16(UND),
	/* 0x9F */ FILL16(LDM_STM_privileged),
